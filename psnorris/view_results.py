...
def view_results(playActivity, **kwargs):
  if playActivity == "peakFinding":
    ...
    for trialCount, detz_offset in enumerate(detz_offsets):
      ...
      cPMan = cctbxPlayMan(kwargs['exp'], kwargs['run_no'], trialCount, '', 'optims', '', 0)
...
if __name__ == "__main__":
  view_results(sys.argv[1], window_size=2, step_size=0.2, detz_offset=589, exp='cxid9114', run_no=108)
